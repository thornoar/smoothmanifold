...
draw(sm1, contourpen = mediumgrey, fill = false);
draw(sm2, contourpen = mediumgrey, fill = false);
draw(intersection(sm1, sm2, round = true));
draw(sm3, contourpen = mediumgrey, fill = false);
draw(intersection(sm2, sm3, round = true));
draw(sm4, contourpen = mediumgrey, fill = false);
