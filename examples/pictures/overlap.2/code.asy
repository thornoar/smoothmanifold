...
fitpath((0,0){up}..{down}(1,0), arrow = delayedArrow(HookHead, begin = true, arc = true), bar = delayedBar(begin = true, end = true, size = 10), p = blue);
fitpath((.5,-1.3){up}..(.6,.7), arrow = delayedArrow(TeXHead));
