...
sm1.setlabel(0, label = "U", labeldir = dir(180));
sm1.view(viewdir);
...
sm2.addsubset(contour = concavepath[2], shift = (0,.15), scale = .49, rotate = 150).setlabel(1, "W", labeldir = dir(-110));
...
sm2.setlabel(0, label = "V", labeldir = dir(150));
