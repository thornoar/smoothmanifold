...
\begin{abstract}
Within the niche of mathematicians, there's a niche of people who need
to draw diagrams in abstract mathematics.
...
This article is for them. It's a survey of the available tools and a showcase
of a library I wrote specifically to simplify the process
...
At that point I realized I wasn't sure how to draw these surfaces. First
of all, I had to choose a tool, of which there are several:

\begin{itemize}
  \item \textbf{Inkscape} (\url{https://www.inkscape.org})\\
    This is a popular and versatile GUI tool for drawing vectorized
    graphics, suitable when little precision is needed. I our case,
    however, 
\end{itemize}
